...
module PlisioAPIClient
  class InvoiceFormResponseDto
    ...
    # Donation hash
    attr_accessor :donate_hash

    # Invoice return url
    attr_accessor :return_url

    # True when psys_cid not in supported by shop
    attr_accessor :psys_cid_unsupported
    ...
    def self.attribute_map
      {
        ...
        :'paid_id' => :'paid_id',
        :'params' => :'params',
        :'donate_hash' => :'donate_hash',
        :'return_url' => :'return_url',
        :'psys_cid_unsupported' => :'psys_cid_unsupported',
        :'txn_id' => :'txn_id',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PlisioAPIClient::InvoiceFormResponseDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PlisioAPIClient::InvoiceFormResponseDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'donate_hash')
        self.donate_hash = attributes[:'donate_hash']
      end
      ...
      if attributes.key?(:'psys_cid_unsupported')
        self.psys_cid_unsupported = attributes[:'psys_cid_unsupported']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          paid_id == o.paid_id &&
          params == o.params &&
          donate_hash == o.donate_hash &&
          return_url == o.return_url &&
          psys_cid_unsupported == o.psys_cid_unsupported &&
          txn_id == o.txn_id &&
    ...
    def hash
      [id, amount, received_amount, pending_amount, remaining_amount, wallet_hash, psys_cid, currency, source_currency, source_rate, expected_confirmations, invoice_commission, invoice_sum, invoice_total_sum, email_already_set, tx_url, tx_id, switch_id, paid_id, params, donate_hash, return_url, psys_cid_unsupported, txn_id, invoice_url].hash
    end
