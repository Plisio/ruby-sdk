...
module PlisioAPIClient
  class CommissionResponseSimpleDto
    ...
    def self.openapi_types
      {
        ...
        :'fee_unit' => :'Object',
        :'fee_fiat' => :'Object',
        :'fee_fiat_unit' => :'Object',
        :'max_amount' => :'Object',
        :'plan' => :'Object',
        :'use_wallet' => :'Object',
        :'use_wallet_balance' => :'Object',
        :'plans' => :'Object',
        :'custom' => :'Object',
        :'errors' => :'Object',
        :'custom_fee_rate' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PlisioAPIClient::CommissionResponseSimpleDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PlisioAPIClient::CommissionResponseSimpleDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          custom == o.custom &&
          errors == o.errors &&
          custom_fee_rate == o.custom_fee_rate
    end
    ...
    def hash
      [commission, fee, fee_unit, fee_fiat, fee_fiat_unit, max_amount, plan, use_wallet, use_wallet_balance, plans, custom, errors, custom_fee_rate].hash
    end
